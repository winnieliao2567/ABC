        ...
        (T.container[0].swiper = T),
          ...
          (T.loadImage = function (e, a, t, s, i, r) {
            ...
            e.complete && i
              ? n()
              : a
              ? ((o = new window.Image()), (o.onload = n), (o.onerror = n), s && (o.sizes = s), t && (o.srcset = t), a && (o.src = a))
              : n();
          }),
          (T.preloadImages = function () {
            function e() {
              void 0 !== T &&
                ...
                T.imagesLoaded === T.imagesToLoad.length && (T.params.updateOnImagesReady && T.update(), T.emit("onImagesReady", T)));
            }
          ...
          (T.updateProgress = function (e) {
            ...
            0 === a
              ...
              : ((T.progress = (e - T.minTranslate()) / a), (T.isBeginning = T.progress <= 0), (T.isEnd = T.progress >= 1)),
          ...
          (T.updatePagination = function () {
            if (T.params.pagination && T.paginationContainer && T.paginationContainer.length > 0) {
              ...
              if ("bullets" === T.params.paginationType) {
                for (
                  var a = T.params.loop ? Math.ceil((T.slides.length - 2 * T.loopedSlides) / T.params.slidesPerGroup) : T.snapGrid.length, t = 0;
                  t < a;
                  t++
                )
              ...
              if ((z && T.emit("onTouchMove", T, a), !(a.targetTouches && a.targetTouches.length > 1))) {
                if (
                  ...
                  (T.isHorizontal() && T.touches.currentY === T.touches.startY) || (!T.isHorizontal() && T.touches.currentX === T.touches.startX)
                    ? (E = !1)
                    : ((t =
                        (180 * Math.atan2(Math.abs(T.touches.currentY - T.touches.startY), Math.abs(T.touches.currentX - T.touches.startX))) /
                        Math.PI),
                  ...
                  if (A) {
                    ...
                    if (
                      (s > 0 && P > T.minTranslate()
                        ? ((r = !1),
                          T.params.resistance && (P = T.minTranslate() - 1 + Math.pow(-T.minTranslate() + I + s, T.params.resistanceRatio)))
                        : s < 0 &&
                          P < T.maxTranslate() &&
                          ((r = !1),
              ...
              if (((i = T.params.followFinger ? (T.rtl ? T.translate : -T.translate) : -P), T.params.freeMode)) {
                ...
                if (T.params.freeModeMomentum) {
                  ...
                  if (u < T.maxTranslate())
                    ...
                    T.params.freeModeMomentumBounce
                      ? (u - T.minTranslate() > h && (u = T.minTranslate() + h), (c = T.minTranslate()), (m = !0), (D = !0))
                      : (u = T.minTranslate());
          ...
          (T.onTransitionEnd = function (e) {
            (T.animating = !1),
              ...
              e &&
                ...
                T.activeIndex !== T.previousIndex &&
                  (T.emit("onSlideChangeEnd", T), T.activeIndex > T.previousIndex ? T.emit("onSlideNextEnd", T) : T.emit("onSlidePrevEnd", T))),
                ...
                if ((T.slides.transition(e), T.params.virtualTranslate && 0 !== e)) {
                  ...
                  T.slides.transitionEnd(function () {
                    if (!a && T) {
                      (a = !0), (T.animating = !1);
                      for (
                        var e = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"], t = 0;
                        t < e.length;
                        t++
                      )
                ...
                for (var a = 0; a < T.slides.length; a++) {
                  ...
                  if (
                    ...
                    0 === d.length && ((d = e('<div class="swiper-slide-shadow-' + (T.isHorizontal() ? "left" : "top") + '"></div>')), t.append(d)),
                      0 === u.length &&
                        ((u = e('<div class="swiper-slide-shadow-' + (T.isHorizontal() ? "right" : "bottom") + '"></div>')), t.append(u)),
                ...
                if (
                  ...
                  T.slides.eq(T.activeIndex).transitionEnd(function () {
                    if (!t && T && e(this).hasClass(T.params.slideActiveClass)) {
                      (t = !0), (T.animating = !1);
                      for (
                        var a = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"], s = 0;
                        s < a.length;
                        s++
                      )
              ...
              setTranslate: function () {
                ...
                for (var s = 0; s < T.slides.length; s++) {
                  ...
                  if ((o <= 1 && o > -1 && ((t = 90 * s + 90 * o), T.rtl && (t = 90 * -s - 90 * o)), i.transform(u), T.params.cube.slideShadows)) {
                    ...
                    0 === c.length && ((c = e('<div class="swiper-slide-shadow-' + (T.isHorizontal() ? "left" : "top") + '"></div>')), i.append(c)),
                      0 === m.length &&
                        ((m = e('<div class="swiper-slide-shadow-' + (T.isHorizontal() ? "right" : "bottom") + '"></div>')), i.append(m)),
                ...
                if (
                  ...
                  if (T.isHorizontal())
                    ...
                    a.transform(
                      "scale3d(" + f + ", 1, " + v + ") translate3d(0px, " + (T.height / 2 + w) + "px, " + -T.height / 2 / v + "px) rotateX(-90deg)"
                    );
                  }
                var y = T.isSafari || T.isUiWebView ? -T.size / 2 : 0;
                T.wrapper.transform(
                  "translate3d(0px,0," + y + "px) rotateX(" + (T.isHorizontal() ? 0 : t) + "deg) rotateY(" + (T.isHorizontal() ? -t : 0) + "deg)"
                );
              },
              setTransition: function (e) {
                T.slides
                ...
                for (
                  ...
                  if ((o.transform(f), (o[0].style.zIndex = 1 - Math.abs(Math.round(d))), T.params.coverflow.slideShadows)) {
                    ...
                    0 === v.length && ((v = e('<div class="swiper-slide-shadow-' + (T.isHorizontal() ? "left" : "top") + '"></div>')), o.append(v)),
                      0 === w.length &&
                        ((w = e('<div class="swiper-slide-shadow-' + (T.isHorizontal() ? "right" : "bottom") + '"></div>')), o.append(w)),
          ...
          (T.lazy = {
            ...
            loadImageInSlide: function (a, t) {
              if (void 0 !== a && (void 0 === t && (t = !0), 0 !== T.slides.length)) {
                var s = T.slides.eq(a),
                  i = s.find(
                    "." + T.params.lazyLoadingClass + ":not(." + T.params.lazyStatusLoadedClass + "):not(." + T.params.lazyStatusLoadingClass + ")"
                  );
            ...
            onTransitionStart: function () {
              T.params.lazyLoading &&
                (T.params.lazyLoadingOnTransitionStart || (!T.params.lazyLoadingOnTransitionStart && !T.lazy.initialImageLoaded)) &&
                T.lazy.load();
            },
              ...
              13 === a.keyCode &&
                (e(a.target).is(T.params.nextButton)
                  ...
                  : e(a.target).is(T.params.prevButton) &&
                    (T.onClickPrev(a), T.isBeginning ? T.a11y.notify(T.params.firstSlideMessage) : T.a11y.notify(T.params.prevSlideMessage)),
            ...
            if (a)
              if ("string" == typeof a) {
                ...
                if (o.indexOf("<") >= 0 && o.indexOf(">") >= 0) {
                  ...
                  for (
                    r = t || "#" !== a[0] || a.match(/[ .<>:~]/) ? (t || document).querySelectorAll(a) : [document.getElementById(a.split("#")[1])],
                      i = 0;
                    i < r.length;
                    i++
                  )
